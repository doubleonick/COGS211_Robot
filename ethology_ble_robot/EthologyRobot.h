...
public:
    ...
    // Thresholds
    // ================================
    static constexpr int PROX_THRESHOLD  = 20;   // cm; was 35.
    // getData() saturates at 18 cm, so 35 fired ~everywhere indoors and
    // made corridors narrower than ~60 cm untraversable (pure oscillation).
